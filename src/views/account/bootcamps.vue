<template>
  <MainLayout>
<div>
  <section class="browse my-10 mt-5">
    <div class="container">
      <div class="row">
        <!-- Sidebar -->
        <div class="col-md-4">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" class="form-control" name="miles" placeholder="Miles From">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
          ...
          <div class="card mb-3">
            <div class="row no-gutters">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">
                    <a href="bootcamp.html">DevCentral Bootcamp
                      <span class="float-right badge badge-success">6.4</span></a>
                  </h5>
